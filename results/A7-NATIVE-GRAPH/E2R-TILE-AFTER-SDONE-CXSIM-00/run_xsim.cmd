@echo off
REM E2R-TILE-AFTER-SDONE-CXSIM-00 — tile chunk after dma_done
REM No board. No bitstream. No vivado.exe impl writer. PROGRAM=NO.
setlocal
set ROOT=D:\Jetking_sem4\SEM_4\arty-a7-online-lm-board
set OUT=%ROOT%\results\A7-NATIVE-GRAPH\E2R-TILE-AFTER-SDONE-CXSIM-00
...
copy /Y "%ROOT%\tests\xsim\tb_e2r_tile_after_sdone_cxsim_00.sv" "%OUT%\tb_e2r_tile_after_sdone_cxsim_00.sv" >nul
copy /Y "%ROOT%\tests\xsim\run_e2r_tile_after_sdone_cxsim_00.tcl" "%OUT%\run_e2r_tile_after_sdone_cxsim_00.tcl" >nul
...
echo === xelab ===
call "%XELAB%" -mt off -O0 tb_e2r_tile_after_sdone_cxsim_00 glbl -s e2r_tile_after_sdone_cxsim_00 -timescale 1ns/1ps 1>xelab_stdout.txt 2>&1
if errorlevel 1 (
...
echo === xsim ===
call "%XSIM%" e2r_tile_after_sdone_cxsim_00 -R -log xsim.log 1>xsim_stdout.txt 2>&1
set RC=%ERRORLEVEL%
echo === done rc=%RC% ===
