@echo off
REM E2R-SDONE-CXSIM-00 — completable responder s_done on leftover dest=4
...
set OUT=%ROOT%\results\A7-NATIVE-GRAPH\E2R-SDONE-CXSIM-00
...
copy /Y "%ROOT%\tests\xsim\tb_e2r_sdone_cxsim_00.sv" "%OUT%\tb_e2r_sdone_cxsim_00.sv" >nul
copy /Y "%ROOT%\tests\xsim\run_e2r_sdone_cxsim_00.tcl" "%OUT%\run_e2r_sdone_cxsim_00.tcl" >nul
...
echo === xelab ===
call "%XELAB%" -mt off -O0 tb_e2r_sdone_cxsim_00 glbl -s e2r_sdone_cxsim_00 -L xpm -timescale 1ns/1ps 1>xelab_stdout.txt 2>&1
if errorlevel 1 (
...
echo === xsim ===
call "%XSIM%" e2r_sdone_cxsim_00 -R -log xsim.log 1>xsim_stdout.txt 2>&1
set RC=%ERRORLEVEL%
echo === done rc=%RC% ===
findstr /C:"E2R_SDONE" /C:"PROBE" /C:"CLASS" /C:"C_FIX" /C:"SGO_" /C:"S_DONE" /C:"BUSY_" /C:"DEST4" /C:"XSIM=" /C:"SOA_" /C:"REACHED" /C:"SNAP" /C:"END_" /C:"AND_MASK" /C:"EXISTENCE" /C:"BOARD_" /C:"WDMA" /C:"FAIL_NO" /C:"GRANT_ROSE" xsim_stdout.txt
exit /b %RC%
